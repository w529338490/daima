 ...
 */
	...
	ob_end_clean();
	$t->set_var("template_nav",$navigator); 
	...
	//profilepage left mod
	ob_start();
	include $BASEPATH."/modules/left_user_navigator/left_user_navigator.php";
	$include_left.=ob_get_contents();
	ob_end_clean();
	

	$sql="select  a.id,a.picture,a.name as infos_category_name,a.module_com,b.page_level,b.dispach_page,b.module_name from  ".$TableInfo_category." as a,".$TableModules." as b where  a.module_id=b.id and  FIND_IN_SET('6',a.module_pos)>0   and a.is_show=1 order by a.sortid" ;
