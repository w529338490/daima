...
<table  width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td >
        ...
        <div class="gallery_com_picturetop_text">
			<?
                $id=$category_id;
            ...
            ?>
            <div class="gallery_com_picturetop_text_category">
               <a href="<?=$link_list_url?>"> <?=$row['infos_category_name']?></a>
            </div>
            <div class="gallery_com_picturetop_text_line"></div>
            <div  class="gallery_com_picturetop_text_picture" style="padding-bottom:5px;">
           
            <a href="<?=$link_url?>"><img  class="gallery_com_picturetop_text_img"      src="<?=$SETUPFOLDER?>/upload/infos/thumbnail_<?=$row['picture']?>" border="0" ></a>
            </div>
            <div class='gallery_com_picturetop_text_text' style="text-align:left;">
            <a  href="<?=$link_url?>"><span class="gallery_com_picturetop_text_Title"><?=$row['info_title']?></span></a>
                   <br />
