  ...
  <tr>
    ...
    <td  style=" text-align:left;">
        ...
        <div  class="gallery_com_text">
			...
			?>
        	<div class="gallery_com_text_category">
            	<a  href="<?=$link_list_url?>"><?=$row['infos_category_name']?></a>
            </div>
            <div class="gallery_com_text_line"></div>
            <div class="gallery_com_text_text">
            	<a  href="<?=$link_url?>"><span class="gallery_com_text_Title"><?=$row['info_title']?></span></a>
                   <br />
