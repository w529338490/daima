...
<table  width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td  style=" text-align:left;">
        ...
        <div class="gallery_com_pictureleft_text_listings">
        <?
		$link_url=$SETUPFOLDER."/".$dispatch_page."?menuid=".$category_id."&level=".$category_level;
		?>
        	<div class="gallery_com_pictureleft_text_listings_category">
                <a  href="<?=$link_url?>"><?=$infos_category_name?></a>
            </div>
            <div class="gallery_com_pictureleft_text_listings_line"></div>
            <div  class="gallery_com_pictureleft_text_listings_list">
            <a  href="<?=$link_url?>"><img class="gallery_com_pictureleft_text_listings_picture"   src="<?=$SETUPFOLDER?>/upload/info_category/thumbnail_<?=$category_picture?>" border="0" ></a>
                <ul>
                <? //   您好
