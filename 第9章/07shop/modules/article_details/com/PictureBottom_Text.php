...
<table  width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td >
        ...
        <div  class="article_details_com_picturebottom_text">
        	<?
                $id=$category_id;
            ...
            ?>
       		<div class="article_details_com_picturebottom_text_category">
                <a href="<?=$link_url?>"><?=$row['infos_category_name']?></a>
            </div>
            <div class="article_details_com_picturebottom_text_line"></div>
            <div  class="article_details_com_picturebottom_text_text"  style="text-align:left;" >
            
            <a href="<?=$link_url?>"><?=cut(filterTag($row['description']),300)?></a>
            </div>
            <div  class="article_details_com_picturebottom_text_picture" style="padding-top:5px;">
            <a href="<?=$link_url?>"><img  class="article_details_com_picturebottom_text_img"   src="<?=$SETUPFOLDER?>/upload/infos/thumbnail_<?=$row['picture']?>" border="0" ></a>
