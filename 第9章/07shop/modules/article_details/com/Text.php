 ...
 <table  width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td  style=" text-align:left;">
        ...
        <div  class="article_details_com_text">
        	<?
				$id=$category_id;
			...
			?>
        	<div class="article_details_com_text_category">
            	<a href="<?=$link_url?>"><?=$row['infos_category_name']?></a>
            </div>
            <div class="article_details_com_text_line"></div>
            <div class="article_details_com_text_text">
