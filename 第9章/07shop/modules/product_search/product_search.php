 ...
 ?>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<?
			...
			$pagenum=$config_row['list_pageturn_num'];
             ...
             if(!empty($fvalue))
             {
                 if($b)
                     $filter.=" and";
                 $filter.=" (".$TableEb_product.".product_name like '%".$fvalue."%' or ".$TableEb_product.".content like '%".$fvalue."%' or  ".$TableEb_product.".keywords like '%".$fvalue."%')  ";
                 $b=true;
             }
		...
		?>
                  ...
                  <td class="product_search_listings">
                      <div class="product_search_listings_picture">
                      <a href="<?=$link_url?>">
                      <img  class="product_search_listings_img"      src="<?=$SETUPFOLDER?>/upload/eb_product/s<?=$result[$i]['picture']?>" border="0" >
                      
                      </a>
                      </div>
                      <div class="product_search_listings_text">
                      <a href="<?=$link_url?>">
                        <?=$result[$i]['product_name']?>
                      </a>
                      </div>
                      <div class="product_search_listings_price">
