...
<table  width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td  style=" text-align:left;">
        ...
        <div  class="article_listings_com_pictureleft_text">
			<?
                $id=$category_id;
            ...
            ?>
            <div class="article_listings_com_pictureleft_text_category">
                <a  href="<?=$link_list_url?>"<?=$row['infos_category_name']?></a>
            </div>
            <div class="article_listings_com_pictureleft_text_line"></div>
            <div  class="article_listings_com_pictureleft_text_text">
            <a href="<?=$link_url?>"><img  class="article_listings_com_pictureleft_img"   style="float:left; padding-right:10px;"  src="<?=$SETUPFOLDER?>/upload/infos/thumbnail_<?=$row['picture']?>" border="0" ></a>
             <a  href="<?=$link_url?>"><span class="article_listings_com_pictureleft_text_Title"><?=$row['info_title']?></span></a>
                   <br />
