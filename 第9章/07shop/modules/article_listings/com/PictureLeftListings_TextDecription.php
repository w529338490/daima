...
<table  width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td  style=" text-align:left;">
        ...
        <div class="article_listings_com_PictureLeftListings_TextDecription">
        <?
		$link_url=$SETUPFOLDER."/".$dispatch_page."?menuid=".$category_id."&level=".$category_level;
		?>
        	<div class="article_listings_com_PictureLeftListings_TextDecription_category">
                <a  href="<?=$link_url?>"><?=$infos_category_name?></a>
            </div>
            <div class="article_listings_com_PictureLeftListings_TextDecription_line"></div>
            <div  class="article_listings_com_PictureLeftListings_TextDecription_list">
                <? //   您好
                ...
                ?>
                   	<div  class="article_listings_com_PictureLeftListings_TextDecription_picture"><a  href="<?=$link_url?>"><img  class="article_listings_com_PictureLeftListings_TextDecription_img"  src="<?=$SETUPFOLDER?>/upload/infos/thumbnail_<?=$result_mod[$k]['picture']?>" border="0" /></a> <a  href="<?=$link_url?>"><?=cut(filterTag($result_mod[$k]['description']),200)?></a></div>
