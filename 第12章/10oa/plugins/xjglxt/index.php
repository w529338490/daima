...
unset($cookie_id); 
$filenames=array('index','left','header','main','deal','student','list','class','result','message','upfile','login','cache','tongji','log','setvar','user','chajian','review','database','template','contribute','ads','editor','announcement','register');
