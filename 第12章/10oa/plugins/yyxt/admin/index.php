...
if (isset($user_name)){
   ...
   echo 	"<table width=\"760\" height=32 border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" class=tableborder_2>
	                   ...
	                   <tr>
                       <td>
                            <a href=\"?filename=admin&gtypeid=$gtypeid\">点击这里开始设置分类</a> 
                       </td>
                     </tr>  
                  </table>";
                  exit;
...
<TABLE cellSpacing=0 cellPadding=0 width="760" border=0 align=center bgcolor=#eeeeee>
	<TR vAlign=bottom align=middle>
      ...
      查询=》 开始：<input type="text" name=st_time size=10 > 结束：<input type="text" name=end_time size=10>
      <select name="classid"><?=$class_list;?></select><input type="submit" name=tt value="开始查询"><font color=red>(时间格式为2008-08-01)</font>
      </td>
     </tr></form>
  </table>
  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0 align=center >
		...
		<td valign=top>
             	...
             	<tr height=28>
		          <td valign='middle' colSpan=4 class=bg>
		        	<b>今天的预约课</b><a name=today></a>
		        </td>
	          </tr>
						<tr class='tab_color_cs' align=center>
							<td width='20%' height=24>教师</td>
							<td width='20%'>班级</td>
							<td width='40%'>多媒体教室</td>
							<td>课次</td>
					  </tr>
		           ...
		           <td valign='middle'colSpan=4 class=bg>
			           <b>注意事项</b>
						...
						<tr class='tab_color_cs' >
							...
							<td width='98%'>1、如果遇到已被预约请与对方老师联系；</td>
					  </tr>
					  ...
					  <tr class='tab_color_cs' height=24>
							<td align=right></td>
							<td>3、保持多功能体教室的卫生整洁；</td>
					  </tr>
					  <tr class='tab_color_cs' height=24>
							<td align=right></td>
							<td>4、如果发现设备问题，请及时与电教管理员联系。</td>
					  </tr>
					</table>
		 </td>
	 </tr>
