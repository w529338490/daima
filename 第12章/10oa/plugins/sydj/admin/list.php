          ...
          if($db->num_rows($result)==1){$adminrepair=1;}
	        $login="<table width=\"99%\" height=40 border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" class=tableborder_2>
                  <form id=\"form1\" name=\"form1\" method=\"post\" action=\"?filename=login\">  
                       ...
                       <td align=right valign=bottom> 当前用户：[$real_name] <a href=\"?filename=index\" >首 页</a> | <a href=\"#\" onclick=popUp('repair','0')>申请实验</a>  | <a href=\"?filename=list\" >我的申请</a> | <a href=\"?filename=admin\">管 理</a> </td>
                       <td width=20></td>
                     </tr>  
                   </form>
                  </table>";
...
while($r=$db->fetch_array($result)){
	          $intime=date("Y/m/d",$r[intime]);
	         	...
	         	$table_show.="
           	               ...
           	               <td align=\"center\" valign=\"middle\" class=$class_style><a href=# onclick=popUp('editrepair','$r[id]') title='只有申请者才能修改'>编辑</a>|<a href=# onclick=popUp('delrepair','$r[id]') title='只有申请者才有权限'>删除</a></td>
         	               </tr>";           
       }        
?>
  ...
  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0 align=center >
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="99%" border=0 align=center class=tableborder_2>        
            <tr>
              ...
              <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0 align=center >
	                 <TR vAlign=bottom align=middle>
	                 	 <TD align=left width=150> &nbsp;&nbsp;<b>当前位置:我的申请</td>
                      <TD align=right height=20><a href="?filename=list">全部</a> | <a href="?filename=list&stateid=0">申请</a> | <a href="?filename=list&stateid=1">准备</a> | <a href="?filename=list&stateid=2">使用</a> | <a href="?filename=list&stateid=3">归还</a> </td>
