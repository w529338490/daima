...
<table width="776" border="0" align="center" cellpadding="0" cellspacing="0" class="tableBorder">
  ...
  <tr>
    <td align="center" valign="top" style="padding:5px;"><table width="974"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="974" height="45" valign="top"><img src="Images/main_booksort_1.gif" width="964" height="43"></td>
      </tr>
      <tr>
        <td height="68" valign="top"><table width="969"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#D2E3E6" bordercolorlight="#FFFFFF">
          <tr align="center">
