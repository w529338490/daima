<?php
	class phpSayTemplate
	{
		...
		function phpSayTemplate ( $template_filename = '' )
		{
			...
			if (!empty($_CONFIG['phpsaytemplate_compiled']))
			{
				$this->temp_dir  =  $_CONFIG['phpsaytemplate_compiled'];
			}
			if (!empty($_CONFIG['phpsaytemplate_cache']))
			{
				$this->cache_dir  =  $_CONFIG['phpsaytemplate_cache'];
			}
