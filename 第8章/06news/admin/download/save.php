...
if($met_webhtm==1){
$fromurl=$met_weburl.$folder[foldername]."/showdownload.php?id=".$id;
$filename="../../".$folder[foldername]."/"."showdownload".$id.".htm";
createhtm($fromurl,$filename);
if($met_en_lang==1){
$fromurl=$met_weburl.$folder[foldername]."/showdownload.php?en=en&id=".$id;
$filename="../../".$folder[foldername]."/"."showdownload".$id."_en.htm";
createhtm($fromurl,$filename);
}
}
if($met_index_type){
