...
$c_page_list = $rowset->link("product.php?class1=$class1&class2=$class2&class3=$class3&search=$search&c_title=$c_title&page=");		
$e_page_list = $rowset->link("product.php?en=en&class1=$class1&class2=$class2&class3=$class3&search=$search&e_title=$e_title&page=");	
